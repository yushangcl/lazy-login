package com.whh.lazy.login.units.generator;

import com.whh.lazy.login.units.StringUtils;
...
//    private static String managerMock_vm = "/template/ManagerMock.vm";
    ...
    public static void generator(
        ...
        String module_path = targetProject + module + "src/main/resources/generatorConfig.xml";
        String DaoModule = targetProject + module;
        String ManagerModule = targetProject + module ;
        String CommonModule = targetProject + module;
...
//            List<Map> result = jdbcUtil.selectByParams(sql, null);
            ...
            for (String tn : result) {
                ...
                table.put("model_name", StringUtils.lineToHump(ObjectUtils.toString(tn)));
                tables.add(table);
            }
//          jdbcUtil.release();
...
//			deleteDir(new File(targetProject_sqlMap + "/src/main/java/" + package_name.replaceAll("\\.", "/") + "/dao/mapper"));
        ...
        for (Map<String, Object> table : tables) {
            File doFile = new File(DaoModule + "src/main/java/" + package_name.replaceAll("\\.", "/") + "/model/" + table.get("model_name") + "DO.java");
